...
# Inherit this class for any model in which the OCR data fetching server action is to be used
class OCRAbstractModel(models.AbstractModel):
    _name = "ocr.abstract.model"
    _description = "OCR Abstract Model"
